...
import { Order } from '../../modules/admin/orders/order.model';
import { Shipment, ShipmentPackage } from '../../modules/admin/shipments/models';
...
export const generatePackingSlip = async (
    ...
    try {
        ...
        if (pdf) {
            ...
            const looksLikeJson =
                contentType.includes('application/json') || buffer.slice(0, 1).toString() === '{';
            if (looksLikeJson) {
