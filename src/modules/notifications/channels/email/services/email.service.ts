...
if (!smtpConfig.host || !smtpConfig.user || !smtpConfig.password) {
    logger.warn(
        'SMTP not fully configured. Email notifications will not work.',
        {
            configured: {
...
export const getStatus = (): {
    ...
    const isConfigured = !!(smtpConfig.host && smtpConfig.user && smtpConfig.password);
    ...
    return {
        ...
        smtpUser: smtpConfig.user ? `${smtpConfig.user.split('@')[0]}@...` : 'Not configured',
