/**
 * Professional New Order Notification Email Template (Sales Team)
 */
export const newOrderNotificationTemplate = (data: {
    orderNumber: string;
                        ...
                        <table border="0" cellpadding="0" cellspacing="0" width="550" style="border-collapse: collapse; background-color: #ffffff; border-radius: 12px; overflow: hidden; box-shadow: 0 4px 10px rgba(0,0,0,0.05);">
                            ...
                            <tr>
                                <td align="center" style="padding: 30px 0; background-color: #4b3832;">
                                    ...
                                    <p style="color: #ffffff; margin: 5px 0 0 0; font-size: 14px;">New Order Alert</p>
                                </td>
                            </tr>
                            ...
                            <tr>
                                <td style="padding: 40px 30px;">
                                    <h2 style="color: #333333; margin: 0 0 20px 0; font-size: 20px;">New Order Placed</h2>
                                    <p style="color: #555555; font-size: 15px; line-height: 24px; margin-bottom: 25px;">
                                        A new order has been placed on the platform. Please review the details below and follow up with the customer.
                                    </p>
                                    ...
                                    <table width="100%" style="background-color: #f8f9fa; border-radius: 8px; border: 1px solid #eeeeee; margin-bottom: 25px;">
                                        <tr>
                                            <td style="padding: 20px;">
                                                ...
                                                <p style="margin: 0 0 10px 0; color: #333333; font-size: 15px;"><strong>Customer Email:</strong> ${data.customerEmail}</p>
                                    ...
                                    <p style="color: #555555; font-size: 15px; line-height: 24px; margin-bottom: 25px;">
                                        Please check the admin panel for complete order details and proceed with the next steps.
                                    </p>
                                        ...
                                        <tr>
                                            <td align="center" style="padding: 20px 0; border-top: 1px solid #eeeeee;">
                                                <p style="margin: 0; color: #888888; font-size: 12px;">
                                                    This is an automated notification from Sappey Order Management System.
                                                </p>
                                            </td>
                                        </tr>
                                    </table>
