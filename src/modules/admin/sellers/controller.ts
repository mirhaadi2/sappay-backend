...
export const listSellersHandler = async (req: AuthenticatedRequest, res: Response) => {
  try {
...
export const getSellerHandler = async (req: AuthenticatedRequest, res: Response) => {
  try {
    const { id } = req.params;
...
export const updateSellerHandler = async (req: AuthenticatedRequest, res: Response) => {
  try {
    const { id } = req.params;
...
export const deleteSellerHandler = async (req: AuthenticatedRequest, res: Response) => {
  try {
    const { id } = req.params;
...
export const approveSellerHandler = async (req: AuthenticatedRequest, res: Response) => {
  try {
    const { id } = req.params;
...
export const rejectSellerHandler = async (req: AuthenticatedRequest, res: Response) => {
  try {
    const { id } = req.params;
    const seller = await adminRejectSeller(id);
    res.json({ success: true, data: seller });
  } catch (error: any) {
...
export const suspendSellerHandler = async (req: AuthenticatedRequest, res: Response) => {
  try {
    const { id } = req.params;
...
export const restoreSellerHandler = async (req: AuthenticatedRequest, res: Response) => {
  try {
    const { id } = req.params;
